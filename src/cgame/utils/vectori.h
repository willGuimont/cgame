...
static i32 Vectori_MinI32(const i32 a, const i32 b) { return a < b ? a : b; }

static i32 Vectori_MaxI32(const i32 a, const i32 b) { return a > b ? a : b; }

static i32 Vectori_ClampI32(const i32 value, const i32 min, const i32 max) {
    return Vectori_MinI32(max, Vectori_MaxI32(min, value));
}

// Match raymath semantics while avoiding UB on divide-by-zero.
static i32 Vectori_SafeDivI32(const i32 numerator, const i32 denominator) {
    return denominator == 0 ? 0 : numerator / denominator;
}

static Vector2i Vector2i_Zero(void) { return (Vector2i) {0, 0}; }

static Vector2i Vector2i_One(void) { return (Vector2i) {1, 1}; }

static Vector2i Vector2i_Add(const Vector2i v1, const Vector2i v2) { return (Vector2i) {v1.x + v2.x, v1.y + v2.y}; }

static Vector2i Vector2i_AddValue(const Vector2i v, const i32 add) { return (Vector2i) {v.x + add, v.y + add}; }

static Vector2i Vector2i_Subtract(const Vector2i v1, const Vector2i v2) {
...
static Vector2i Vector2i_Multiply(const Vector2i v1, const Vector2i v2) {
    return (Vector2i) {v1.x * v2.x, v1.y * v2.y};
}

static Vector2i Vector2i_Negate(const Vector2i v) { return (Vector2i) {-v.x, -v.y}; }

static Vector2i Vector2i_Divide(const Vector2i v1, const Vector2i v2) {
    return (Vector2i) {Vectori_SafeDivI32(v1.x, v2.x), Vectori_SafeDivI32(v1.y, v2.y)};
}

static Vector2i Vector2i_Min(const Vector2i v1, const Vector2i v2) {
    return (Vector2i) {Vectori_MinI32(v1.x, v2.x), Vectori_MinI32(v1.y, v2.y)};
}

static Vector2i Vector2i_Max(const Vector2i v1, const Vector2i v2) {
    return (Vector2i) {Vectori_MaxI32(v1.x, v2.x), Vectori_MaxI32(v1.y, v2.y)};
}

static Vector2i Vector2i_Clamp(const Vector2i v, const Vector2i min, const Vector2i max) {
    return (Vector2i) {Vectori_ClampI32(v.x, min.x, max.x), Vectori_ClampI32(v.y, min.y, max.y)};
}

static bool Vector2i_Equals(const Vector2i p, const Vector2i q) { return p.x == q.x && p.y == q.y; }

static Vector3i Vector3i_Zero(void) { return (Vector3i) {0, 0, 0}; }

static Vector3i Vector3i_One(void) { return (Vector3i) {1, 1, 1}; }

static Vector3i Vector3i_Add(const Vector3i v1, const Vector3i v2) {
    return (Vector3i) {v1.x + v2.x, v1.y + v2.y, v1.z + v2.z};
}

static Vector3i Vector3i_AddValue(const Vector3i v, const i32 add) {
    return (Vector3i) {v.x + add, v.y + add, v.z + add};
}

static Vector3i Vector3i_Subtract(const Vector3i v1, const Vector3i v2) {
    return (Vector3i) {v1.x - v2.x, v1.y - v2.y, v1.z - v2.z};
}

static Vector3i Vector3i_SubtractValue(const Vector3i v, const i32 sub) {
...
static Vector3i Vector3i_Multiply(const Vector3i v1, const Vector3i v2) {
    return (Vector3i) {v1.x * v2.x, v1.y * v2.y, v1.z * v2.z};
}

static Vector3i Vector3i_Negate(const Vector3i v) { return (Vector3i) {-v.x, -v.y, -v.z}; }

static Vector3i Vector3i_Divide(const Vector3i v1, const Vector3i v2) {
    return (Vector3i) {Vectori_SafeDivI32(v1.x, v2.x), Vectori_SafeDivI32(v1.y, v2.y), Vectori_SafeDivI32(v1.z, v2.z)};
}

static Vector3i Vector3i_Min(const Vector3i v1, const Vector3i v2) {
    return (Vector3i) {Vectori_MinI32(v1.x, v2.x), Vectori_MinI32(v1.y, v2.y), Vectori_MinI32(v1.z, v2.z)};
}

static Vector3i Vector3i_Max(const Vector3i v1, const Vector3i v2) {
    return (Vector3i) {Vectori_MaxI32(v1.x, v2.x), Vectori_MaxI32(v1.y, v2.y), Vectori_MaxI32(v1.z, v2.z)};
}

static Vector3i Vector3i_Clamp(const Vector3i v, const Vector3i min, const Vector3i max) {
    return (Vector3i) {Vectori_ClampI32(v.x, min.x, max.x), Vectori_ClampI32(v.y, min.y, max.y),
                       Vectori_ClampI32(v.z, min.z, max.z)};
}

static bool Vector3i_Equals(const Vector3i p, const Vector3i q) { return p.x == q.x && p.y == q.y && p.z == q.z; }

static Vector4i Vector4i_Zero(void) { return (Vector4i) {0, 0, 0, 0}; }

static Vector4i Vector4i_One(void) { return (Vector4i) {1, 1, 1, 1}; }

static Vector4i Vector4i_Add(const Vector4i v1, const Vector4i v2) {
    return (Vector4i) {v1.x + v2.x, v1.y + v2.y, v1.z + v2.z, v1.w + v2.w};
}

static Vector4i Vector4i_AddValue(const Vector4i v, const i32 add) {
    return (Vector4i) {v.x + add, v.y + add, v.z + add, v.w + add};
}

static Vector4i Vector4i_Subtract(const Vector4i v1, const Vector4i v2) {
    return (Vector4i) {v1.x - v2.x, v1.y - v2.y, v1.z - v2.z, v1.w - v2.w};
}

static Vector4i Vector4i_SubtractValue(const Vector4i v, const i32 sub) {
...
static Vector4i Vector4i_Multiply(const Vector4i v1, const Vector4i v2) {
    return (Vector4i) {v1.x * v2.x, v1.y * v2.y, v1.z * v2.z, v1.w * v2.w};
}

static Vector4i Vector4i_Negate(const Vector4i v) { return (Vector4i) {-v.x, -v.y, -v.z, -v.w}; }

static Vector4i Vector4i_Divide(const Vector4i v1, const Vector4i v2) {
...
static bool Vector4i_Equals(const Vector4i p, const Vector4i q) {
