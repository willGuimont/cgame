...
void CGame_DrawTextScaled(Font font, const char *text, i32 pos_x, i32 pos_y, i32 base_font_size, i32 max_width,
                          Color color);
...
void CGame_DrawButton(Font font, Rectangle rect, const char *text, Color bg, Color text_col, bool hovered,
                      i32 base_font_size);
